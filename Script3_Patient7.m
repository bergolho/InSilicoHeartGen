...
for index=1
    ...
    %% read original mesh
        ...
        Data4EM=load(fullfile(case_folder, strcat('ensi_Fine_','pac7'), 'Case_Fine.mat')) ; %choose between the mesh files  (coarse for EM or fine for EP)
...
%         %read field data
        casepath=fullfile(resultspath,name_final,'ensipac7');
