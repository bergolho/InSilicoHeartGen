...
for index=1
    ...
    %% read original mesh
        ...
        Field_generator_UKBB_function24(Fiber_info,meshformat,pericardium_level, epiendo, epiendoRV,requiresInterpolation,['pac10']);
...
fibrosis_filename = strcat(directoryResults,'\Patient_10_refined_surface_mesh_aligned\ensipac10\CSVFiles\pac10_coarse_fibrosis_mask.csv');
